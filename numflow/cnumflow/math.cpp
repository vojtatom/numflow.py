 ...
 */
  __pyx_t_2 = ((PyObject *)__pyx_f_7numflow_8cnumflow_6common_create_1d_float_numpy((__pyx_v_streamlines[0]).y, (__pyx_v_streamlines[0]).dy)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
 ...
 */
  __pyx_t_2 = ((PyObject *)__pyx_f_7numflow_8cnumflow_6common_create_1d_float_numpy((__pyx_v_streamlines[0]).f, (__pyx_v_streamlines[0]).df)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
