...
class NotebookForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['title', 'data']
        widgets = {
            'title': forms.TextInput(attrs={'placeholder': 'Title', 'id': 'notebook_title'}),
            'data': forms.Textarea(attrs={'placeholder': 'Here goes your code', 'id': 'notebook_data', 'class': 'editor'}),
        }